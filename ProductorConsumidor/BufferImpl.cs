    ...
    public class BufferImpl : IBuffer
    {
        ...
        { 
            ...
            { 
                ...
                { 
                    Console.WriteLine("{0} está intentando leer.", Thread.CurrentThread.Name);
                ...
                Monitor.Pulse(this); int copiaBuffer = _buffer; Monitor.Exit(this);
                return copiaBuffer; 
            } 
            set 
            { 
                ...
                {
                    Console.WriteLine("{0} está intentando escribir.", Thread.CurrentThread.Name);
                    MostrarEstado($"Buffer lleno. {Thread.CurrentThread.Name} en espera.");
                    Monitor.Wait(this); 

                }
                _buffer = value; _conteoBufferOcupado++; 
                MostrarEstado($"{Thread.CurrentThread.Name} escribe {_buffer}");
                Monitor.Pulse(this); Monitor.Exit(this); } 
        }
